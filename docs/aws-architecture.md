...
## 1. 목표
이 데모의 AWS 아키텍처는 실제 금융 서비스 운영 수준 전체를 구현하기 위한 것이 아니라, 발표와 평가에서 시스템 이해도를 보여주기 위한 구조이다.
...
| 비즈니스 로직 | AWS Lambda | 계좌 요약, 상품 조회, AI 상담 프록시 |
...
- 1주 프로젝트 특성상 실제 운영 자동화 대신 구조적 이해에 집중함
